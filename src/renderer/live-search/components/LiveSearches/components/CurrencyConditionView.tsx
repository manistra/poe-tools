    ...
    <div className="flex flex-row gap-1">
      {currencyConditions?.map((condition, index) => (
        <div
          ...
          className="flex flex-row items-center rounded  border border-gray-700/40 text-[10px] text-gray-600"
        >
          <div className="p-[2px] border-r border-dashed border-gray-700/40">
            <img
          ...
          {condition.minPrice && (
            <div className="px-1 border-r border-dashed border-gray-700/40">
              <span>Min: </span>
